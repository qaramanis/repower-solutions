...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Repower Solutions | Τεχνική Κατασκευαστική Εταιρεία",
    description:
      "Τεχνική Κατασκευαστική Εταιρεία στη Θεσσαλονίκη. Υπηρεσίες: Πρόγραμμα Εξοικονομώ, Ανακαινίσεις, Φωτοβολταικά, Αντλίες Θερμότητας, Τεχνικός Ασφαλείας, Ενεργειακός Επιθεωρητής, Πιστοποιητικά Ενεργειακής Απόδοσης (ΠΕΑ), Η/Μ Μελέτες, Οικοδομικές Άδειες, Άδειες Λειτουργίας, Τακτοποίηση Αυθαιρέτων, Ηλεκτρονική Ταυτότητα Κτιρίου",
          ...
          {`
            {
              ...
              "description": "Τεχνική Κατασκευαστική Εταιρεία στη Θεσσαλονίκη. Υπηρεσίες: Πρόγραμμα Εξοικονομώ, Ανακαινίσεις, Φωτοβολταικά, Αντλίες Θερμότητας, Τεχνικός Ασφαλείας, Ενεργειακός Επιθεωρητής, Πιστοποιητικά Ενεργειακής Απόδοσης (ΠΕΑ), Η/Μ Μελέτες, Οικοδομικές Άδειες, Άδειες Λειτουργίας, Τακτοποίηση Αυθαιρέτων, Ηλεκτρονική Ταυτότητα Κτιρίου",
              "address": {
                "@type": "PostalAddress",
