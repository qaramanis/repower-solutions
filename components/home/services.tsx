...
const SERVICES_DATA = [
  {
    ...
    title: "Η/Μ Εργα",
    description: [
      "Σας προσφέρουμε εξειδικευμένες ηλεκτρομαμηχανικές μελέτες για κτιρακές και βιομηχανικές εγκαταστάσεις, με στόχο την παροχή της βέλτιστης κατασκευαστικής και ενεργειακής λύσης σε κάθε έργο.",
